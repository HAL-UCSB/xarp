...
class AsyncXR:
    ...
    async def bundle(self, **kwargs) -> None:
        await self._execute(BundleCommand, **kwargs)
...
class XR:
    ...
    def bundle(self, *keys) -> None:
        return self._sync(self.as_async.bundle, *keys)
